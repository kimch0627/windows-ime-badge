...
public static class Strings
{
    ...
    static readonly Dictionary<string, string> Ko = new()
    {
        ...
        ["look.swatch.tip"] = "마지막 견본은 사용자 지정 색입니다. 글자색(흰/검)은 고른 색의 밝기에 맞춰 자동으로 정해집니다.",
        ["preview.light"] = "밝은 배경",
        ["preview.dark"] = "어두운 배경",
    ...
    static readonly Dictionary<string, string> En = new()
    {
        ...
        ["look.swatch.tip"] = "The last swatch is a custom color. Text color (white/black) is chosen automatically from the brightness of the color you pick.",
