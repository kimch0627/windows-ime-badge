...
;
; 빌드:  ISCC.exe /DMyAppVersion=1.2.3 /DMySourceExe=..\out\sc\ImeBadge.exe installer\ImeBadge.iss
; 결과:  installer\Output\ImeBadge-Setup-1.2.3.exe
;
; 설계:
...
;      ImeBadge-Setup-1.2.3.exe /SILENT /SUPPRESSMSGBOXES /NOCANCEL /NORESTART /RESTARTAPP /CURRENTUSER /DIR="<기존 위치>"
